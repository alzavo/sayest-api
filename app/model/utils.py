...
from app.constants.audio_properties import MAX_AUDIO_DURATION_SECONDS, MONO_CHANNEL, SAMPLING_RATE
import logging
...
def run_model_inference(waveform, phonemes, model, processor):
    ...
    # Convert to standard list and adjust index (0->1) if your logic requires it
    # Gradio code did `score = int(score) + 1`
